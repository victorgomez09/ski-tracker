...
interface PisteDetailPanelProps {
    piste: any;
    onClose: () => void;
}
...
export const PisteDetailPanel: React.FC<PisteDetailPanelProps> = ({ piste, onClose }) => {
    ...
    const pisteName = piste.Name || tags.name || "Pista sin nombre";
    const ref = tags.ref || "•";
    const difficulty = piste.Difficulty || tags.difficulty || "easy";
    ...
    return (
        <div className="absolute top-4 left-4 z-1000 w-95 bg-white rounded-lg shadow-xl border border-gray-100 p-5 font-sans text-gray-800">
            ...
            <div className="flex items-center gap-3 mb-3">
                ...
                <h2 className="text-2xl font-bold tracking-tight text-gray-900">{pisteName}</h2>
            </div>
