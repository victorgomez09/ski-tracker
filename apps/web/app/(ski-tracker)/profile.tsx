...
import { Camera, Check, Pencil, X, LogOut, Moon, Sun, User, Mail, Settings, Clock, Activity } from "lucide-react-native";
...
export default function ProfileView() {
    ...
    const updateActivityType = async (type: "snow" | "ski") => {
        if (user) {
            try {
                const request = await api.put<UserType>(`${API_BASE_URL}/users/${user.id}`, {
                    ...user,
                    activity_type: type,
                }, {
                    headers: {
    ...
    const onSubmit = async (data: ProfileFormValues) => {
        try {
            setSaving(true);
            const response = await api.put<UserType>(`${API_BASE_URL}/users/${user?.id}`, { ...data, id: user?.id, avatar_url: avatarUrl, activity_type: user?.activity_type })
                ...
                <View style={styles.wrapper}>
                                    ...
                                    <View style={styles.badgeRow}>
                                        <View style={[styles.badge, { backgroundColor: colors.surface }]}>
                                            ...
                                            <Text style={styles.badgeText}>
                                                {user.activity_type === 'ski' ? t('ski_emoji') + ' Skiier' : t('snowboard_emoji') + ' Snowboarder'}
                                            </Text>
                                        </View>
                                    </View>
                                </View>
                    ...
                    <View style={styles.sectionCard}>
                        <View style={styles.sectionHeader}>
                            ...
                            <Text style={styles.sectionTitle}>{t('personal_info') || 'Información Personal'}</Text>
                        </View>
                    ...
                    <View style={styles.sectionCard}>
                        ...
                        <View style={styles.modalityButtons}>
                            ...
                            >
                                ...
                                <Text style={[
                                    styles.modalityText,
                                    user?.activity_type === 'ski' ? styles.modalityTextActive : styles.modalityTextInactive
                                ]}>{t('ski')}</Text>
                            </TouchableOpacity>
                            ...
                            >
                                ...
                                <Text style={[
                                    styles.modalityText,
                                    user?.activity_type === 'snow' ? styles.modalityTextActive : styles.modalityTextInactive
                                ]}>{t('snowboard')}</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                                ...
                                <View style={styles.trackingContainer}>
                                    <View style={styles.trackingPillSelector}>
                                        <TouchableOpacity
                                            ...
                                            activeOpacity={0.8}
                                        >
                                            <Text style={[styles.trackingPillText, value === 1000 && styles.trackingPillTextActive]}>1s</Text>
                                        </TouchableOpacity>
                                        ...
                                        <TouchableOpacity
                                            ...
                                            activeOpacity={0.8}
                                        >
                                            <Text style={[styles.trackingPillText, value === 3000 && styles.trackingPillTextActive]}>3s</Text>
                                        </TouchableOpacity>
                                        ...
                                        <TouchableOpacity
                                            ...
                                            activeOpacity={0.8}
                                        >
                                            <Text style={[styles.trackingPillText, value === 5000 && styles.trackingPillTextActive]}>5s</Text>
                                        </TouchableOpacity>
                                    </View>
                                    
                                    <Text style={styles.helperText}>
                                        {value === 1000 ? t('each_1_second') : value === 3000 ? t('each_3_seconds') : t('each_5_seconds')} — {t('time_tracking_desc')}
                                    </Text>
                                </View>
                            )}
                        />
