  ...
  const selectedResortSummary = useMemo(() => {
    ...
    return {
      ...
      pistesBreakdown: {
        ...
        intermediate:
          pistes.filter((p) => p.Difficulty?.toLowerCase() === 'intermediate').length ?? 0,
        advanced:
          pistes.filter(
            (p) =>
              p.Difficulty?.toLowerCase() === 'advanced' || p.Difficulty?.toLowerCase() === 'expert'
          ).length ?? 0,
      },
      liftsBreakdown: {
    ...
    return (
      <SafeAreaView edges={['top', 'bottom']} style={{ flex: 1, backgroundColor: 'transparent' }}>
        <ScrollView style={styles.detailsScrollView}>
          ...
          <View style={styles.headerBanner}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
              <TouchableOpacity
                ...
                onPress={() => toggleFavorite(selectedResort)}>
                <Star
                  size={18}
                  color={isFavorite(selectedResort.ID) ? '#F59E0B' : colors.textSecondary}
                  fill={isFavorite(selectedResort.ID) ? '#F59E0B' : 'transparent'}
                />
              </TouchableOpacity>
              <TouchableOpacity
            ...
            <View style={styles.metricsGrid}>
              ...
              <View style={styles.metricCard}>
                ...
                <Text style={styles.metricValue}>
                  {selectedResortSummary?.distance.toFixed(1)}{' '}
                  <Text style={{ fontSize: 12, color: colors.textSecondary }}>{t('km')}</Text>
                </Text>
              </View>
            </View>
          </View>
              ...
              <View style={styles.breakdownGrid}>
                <View style={styles.breakdownCard}>
                  ...
                  <View>
                    ...
                    <Text style={styles.breakdownValue}>
                      {t('runs_count', { count: selectedResortSummary.pistesBreakdown.novice })}
                    </Text>
                  </View>
                </View>
                ...
                <View style={styles.breakdownCard}>
                  ...
                  <View>
                    ...
                    <Text style={styles.breakdownValue}>
                      {t('runs_count', { count: selectedResortSummary.pistesBreakdown.easy })}
                    </Text>
                  </View>
                </View>
                ...
                <View style={styles.breakdownCard}>
                  ...
                  <View>
                    ...
                    <Text style={styles.breakdownValue}>
                      {t('runs_count', {
                        count: selectedResortSummary.pistesBreakdown.intermediate,
                      })}
                    </Text>
                  </View>
                </View>
                ...
                <View style={styles.breakdownCard}>
                  <View
                    style={[
                      styles.statusDot,
                      { backgroundColor: '#000000', borderWidth: 1, borderColor: colors.border },
                    ]}
                  />
                  <View>
                    <Text style={styles.breakdownLabel}>{t('expert')}</Text>
                    <Text style={styles.breakdownValue}>
                      {t('runs_count', { count: selectedResortSummary.pistesBreakdown.advanced })}
                    </Text>
                  </View>
                </View>
              </View>
              ...
              <View style={styles.breakdownGrid}>
                <View style={styles.breakdownCard}>
                  ...
                  <View>
                    ...
                    <Text style={styles.breakdownValue}>
                      {selectedResortSummary.liftsBreakdown.chair_lift}
                    </Text>
                  </View>
                </View>
                ...
                <View style={styles.breakdownCard}>
                  ...
                  <View>
                    ...
                    <Text style={styles.breakdownValue}>
                      {selectedResortSummary.liftsBreakdown.drag_lift}
                    </Text>
                  </View>
                </View>
                ...
                <View style={styles.breakdownCard}>
                  ...
                  <View>
                    ...
                    <Text style={styles.breakdownValue}>
                      {selectedResortSummary.liftsBreakdown.magic_carpet}
                    </Text>
                  </View>
                </View>
                ...
                <View style={styles.breakdownCard}>
                  ...
                  <View>
                    ...
                    <Text style={styles.breakdownValue}>
                      {selectedResortSummary.liftsBreakdown.rope_tow}
                    </Text>
                  </View>
                </View>
              </View>
          ...
          {/* Weather Forecast */}
          {weatherData && <WeatherForecastDetails data={weatherData} />}

          {/* Sessions Log */}
          <View style={{ marginVertical: SPACING.md }}>
            <View style={styles.sessionHeaderRow}>
              <Text style={styles.sectionHeader}>
                {t('ski_sessions_count', { count: sessions.length })}
              </Text>
          ...
          <View style={[styles.footerActions, !isWeb && styles.footerActionsGrid]}>
            <TouchableOpacity
              ...
              onPress={() => {
                router.navigate({
                  pathname: '/map',
                  params: { lat: selectedResort.Latitude, lon: selectedResort.Longitude, zoom: 12 },
                });
                setTimeout(() => setSelectedResortWithCache(null), 100);
              }}>
  ...
  const renderResortCard = (resort: Resort) => {
    ...
    return (
      <TouchableOpacity
        ...
        style={[
          styles.resortCard,
          isSelected ? styles.resortCardSelected : styles.resortCardUnselected,
        ]}
        ...
        <View style={styles.resortCardHeader}>
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12, flex: 1 }}>
            ...
            <View style={{ flex: 1 }}>
              <Text style={[styles.resortCardName, isSelected && { color: colors.primaryDark }]}>
                {resort.Name}
              </Text>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
            ...
            <View style={styles.resortCardBadge}>
              <Text style={styles.resortCardBadgeText}>
                {t('lifts_count', { count: resort.total_lifts ?? 0 })}
              </Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.resortCardFooter}>
          <Text style={styles.resortCardFooterText}>
            {t('km_runs', { distance: resort.distance_km?.toFixed(1) ?? '0.0' })}
          </Text>
        </View>
      </TouchableOpacity>
    );
    ...
    <SafeAreaView edges={['top']} style={{ flex: 1, backgroundColor: 'transparent' }}>
      ...
      <View style={styles.container}>
        ...
        <ScrollView
          ...
          {/* Favorites Accordion */}
          <View style={styles.favoritesAccordion}>
            <TouchableOpacity
              style={styles.favoritesAccordionHeader}
              onPress={() => setFavoritesExpanded(!favoritesExpanded)}
              activeOpacity={0.7}>
              <View style={styles.favoritesAccordionHeaderLeft}>
                <Star size={18} color="#F59E0B" fill="#F59E0B" />
                <Text style={styles.favoritesAccordionTitle}>{t('favorite_resorts')}</Text>
              ...
              <View style={styles.favoritesAccordionContent}>
                {isLoadingFavorites && favorites.length === 0 ? (
                  ...
                  <View style={styles.emptyFavoritesContainer}>
                    <Star size={24} color={colors.textLight} />
                    <Text style={styles.emptyFavoritesTitle}>{t('no_favorite_resorts')}</Text>
                    <Text style={styles.emptyFavoritesSubtitle}>
                      {t('no_favorite_resorts_desc')}
                    </Text>
                  </View>
                )}
              </View>
          ...
          <View style={styles.searchHeader}>
            <Text style={styles.searchSectionTitle}>{t('search_resorts')}</Text>
          ...
          {resorts.length > 0 && (
            <View style={styles.matchingResortsContainer}>
              ...
              <View style={styles.matchingResortsList}>
                {resorts.map((resort) => renderResortCard(resort))}
              </View>
            </View>
          )}
          ...
          {resorts.length === 0 && searchTerm.length <= 2 && (
            <View style={styles.emptyStateContainer}>
              ...
              <Text style={styles.emptyStateSubtitle}>{t('explore_resorts_desc')}</Text>
            </View>
          )}
...
const getStyles = (colors: typeof LIGHT_COLORS) =>
  StyleSheet.create({
    ...
    favoritesAccordionHeaderLeft: {
      flexDirection: 'row',
      alignItems: 'center',
      gap: 8,
    },
    favoritesAccordionTitle: {
      fontSize: 14,
      fontWeight: '700',
